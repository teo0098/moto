...
<body>
    ...
    <div class="container-fluid" style="background-image: url('../assets/cars-gora-prawa.jpg'); height: 400px; background-size: cover; background-position:center">
        <div class="row">
            <div class="col-md-4 col-12" style="border: 4px solid yellow; height:400px">
            ...
            <div class="col-md-4 col-12" style="border: 4px solid red; height:400px">
                <div class="input-group">
                    <input type="text" class="form-control" aria-label="Text input with dropdown button">
                    <div class="input-group-append">
                        <div class="dropdown">
            ...
            <div class="col-md-4 col-12" style="border: 4px solid blue; height:400px">
                <div class="row">
                    <div class="col-md-6 col-12" style="border: 4px solid blue; height:400px">
                        <div class="input-group">
                            <input type="text" class="form-control" aria-label="Text input with dropdown button">
                            <div class="input-group-append">
                                <div class="dropdown">
