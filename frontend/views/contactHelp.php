...
<body>
    ...
    <div class="container">
        ...
        }else if (isset($_SESSION["Submission"]) && $_SESSION["Submission"]=="Wystąpił błąd przy wysyłaniu zgłoszenia" || isset($_SESSION["Submission"]) && $_SESSION["Submission"]=="Wypełnij wszystkie pola tekstowe") {
