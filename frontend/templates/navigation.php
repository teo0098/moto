                ...
                <ul class="navbar-nav">
                    ...
                    <?php
                        if (isset($_SESSION['userName'])) {
                            echo '<li class="nav-item" style="margin-right: 20px"><a data-test-id="userTab" class="nav-link" href="../views/userprofile.php"><i style="margin-right: 5px" class="fas fa-user"></i>'.$_SESSION['userName'].'</a></li>
